...
const schema = Joi.object({
  ...
  cache: {
    ...
    options: {
      ...
      partition: Joi.string().default('coreai-mcu-frontend'),
  ...
  cookie: {
    cookieNameCookiePolicy: Joi.string().default('coreai_mcu_frontend_cookie_policy'),
    cookieNameSession: Joi.string().default('coreai_mcu_frontend_session'),
...
const config = {
  ...
  cookie: {
    cookieNameCookiePolicy: 'coreai_mcu_frontend_cookie_policy',
    cookieNameSession: 'coreai_mcu_frontend_session',
    isSameSite: 'Lax',
...
value.messagingConfig = messagingConfig
